export const EDITOR_GRID_TEMPLATE = {
  ...
  left: 'grid-template-columns: 1fr 5px 1fr; grid-template-rows: 1fr 5px 1fr 5px 1fr;',
  right: 'grid-template-columns: 1fr 5px 1fr; grid-template-rows: 1fr 5px 1fr 5px 1fr;',
  top: 'grid-template-columns: 1fr 5px 1fr 5px 1fr; grid-template-rows: 1fr 5px 1fr;'
}
